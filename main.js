...
const lessFuel = (p1less, p1fuel) => console.log(chalk.bold.red(`${p1less} fuel is ${p1fuel}`));
const moreFuel = (p1less, p1fuel) => console.log(chalk.bold.green(`${p1less} fuel is ${p1fuel}`));
    ...
    switch (opponent) {
        case 'Skeleton':
            ...
            if (opt1 === 'Drink Portion') {
                p1.fuelIncrease();
                console.log(chalk.bold.italic.green(`${p1.name}'s fuel is restored to ${p1._fuel}`));
            }
